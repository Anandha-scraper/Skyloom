...
export class WeatherApiService {
  ...
  constructor() {
    ...
    console.log('Mobile WeatherApiService initialized with baseUrl:', this.baseUrl);
  }
  ...
  private async makeRequest<T>(endpoint: string, params: Record<string, string>): Promise<T> {
    ...
    console.log(`Making mobile API request to: ${url.toString()}`);
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.error(`Mobile API Error Response:`, errorText);
      ...
      console.error(`Mobile API request failed for ${endpoint}:`, error);
      throw error;
    }
  }
